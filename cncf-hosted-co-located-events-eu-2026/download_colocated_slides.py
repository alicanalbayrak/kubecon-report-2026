#!/usr/bin/env python3
"""
CNCF-hosted Co-located Events Europe 2026 - Schedule Scraper & Slide Downloader
...
Usage:
    python3 download_colocated_slides.py
"""
...
# ── Configuration ───────────────────────────────────────────────────────────
BASE_URL = "https://colocatedeventseu2026.sched.com"
OUTPUT_DIR = Path("colocated_eu_2026_slides")
...
FILTER_TYPES = [
    ("Agentics Day: MCP + Agents",    "overview/type/Agentics+Day%3A+MCP+%2B+Agents"),
    ("ArgoCon",                        "overview/type/ArgoCon"),
    ("BackstageCon",                   "overview/type/BackstageCon"),
    ("Breaks",                         "overview/type/Breaks"),
    ("CiliumCon",                      "overview/type/CiliumCon"),
    ("Cloud Native AI + Kubeflow Day", "overview/type/Cloud+Native+AI+%2B+Kubeflow+Day"),
    ("Cloud Native Telco Day",         "overview/type/Cloud+Native+Telco+Day"),
    ("FluxCon",                        "overview/type/FluxCon"),
    ("KeycloakCon",                    "overview/type/KeycloakCon"),
    ("Kubernetes on Edge Day",         "overview/type/Kubernetes+on+Edge+Day"),
    ("KyvernoCon",                     "overview/type/KyvernoCon"),
    ("Observability Day",              "overview/type/Observability+Day"),
    ("Open Source SecurityCon",        "overview/type/Open+Source+SecurityCon"),
    ("Open Sovereign Cloud Day",       "overview/type/Open+Sovereign+Cloud+Day"),
    ("OpenTofu Day",                   "overview/type/OpenTofu+Day"),
    ("Platform Engineering Day",       "overview/type/Platform+Engineering+Day"),
    ("Registration",                   "overview/type/Registration"),
    ("WasmCon",                        "overview/type/WasmCon"),
]
...
def main():
    ...
    index: dict = {
        "conference": "CNCF-hosted Co-located Events Europe 2026",
